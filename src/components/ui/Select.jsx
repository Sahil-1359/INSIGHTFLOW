                    ...
                    <div className="flex items-center gap-1">
                        ...
                        {clearable && hasValue && !loading && (
                            <span
                                ...
                                className="h-4 w-4 inline-flex items-center justify-center rounded hover:bg-accent/30 cursor-pointer"
                                onMouseDown={(e) => { e.preventDefault(); e.stopPropagation(); handleClear(e); }}
                            >
                                <X className="h-3 w-3" />
                            </span>
                        )}
